...
function init() {
  ...
  add.addEventListener('click', () => {
    content.insertBefore(createQR('https://github.com/mqzacj3432/www/blob/master/README.md?n#1'), add)
  });
  ...
  let localQr = JSON.parse(localStorage.getItem('_local_qr_codes_') || '["https://github.com/mqzacj3432/www/blob/master/README.md?n#1"]');
